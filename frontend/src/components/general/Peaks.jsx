    ...
    <div className="container mx-auto mb-20 md:mb-[140px] px-4 md:px-6">
      {peaksData.map((item, index) => {
        ...
        return (
          ...
          >
            {/* Image Section - No motion on mobile */}
            {isMobile ? (
            ...
            {/* Text Section - No motion on mobile */}
            {isMobile ? (
              <div className="flex flex-col items-start justify-between gap-4 md:gap-5 w-full md:w-1/2">
                ...
                <p className="text-sm md:text-base text-[#020106] uppercase font-semibold cursor-pointer group">
                  {item.cta}
