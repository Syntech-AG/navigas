  ...
  return (
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row items-start justify-between py-10 md:py-[170px] w-full md:gap-5 lg:gap-0">
        {/* Left Section - No motion on mobile */}
        {isMobile ? (
          <div className="text-[#050505] flex flex-col w-full md:w-[60%] mt-10 md:mt-0">
        ...
        {/* Right Section - No motion on mobile */}
        {isMobile ? (
          <div className="text-[#494B4E] flex flex-col items-start md:items-end w-full md:w-[40%] mt-12 md:mt-0">
            <div className="overflow-hidden rounded-lg w-fit h-fit lg:w-[75%] lg:h-[90%]">
              <video
            ...
            <div className="-ml-0 xl:-ml-40">
              <p className="text-[#494B4E] text-[14px] md:text-[16px] xl:text-[20px] mt-6 md:mt-[40px] leading-8">
                Wir wollen den traditionellen Autobesitz transformieren, indem
                wir mit nur wenigen Klicks Zugang zum On-Demand-Automobil
                bieten. Dank eines flexiblen Abonnements und einer Auswahl von
                Fahrzeugen, die ständig erneuert werden, finden Sie ein Angebot,
                das Ihren Bedürfnissen entspricht. Wir verbessern unsere
                digitalen Prozesse Tag für Tag, um Ihr Kundenerlebnis zu
                verbessern. So sparen wir Ihnen nicht nur Zeit und Mühe, sondern
                garantieren Ihnen Sicherheit, Gelassenheit und Einsparungen
      ...
      {/* Bottom Section - No motion on mobile */}
      {isMobile ? (
