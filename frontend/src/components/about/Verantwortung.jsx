...
const Verantwortung = () => {
  ...
  return (
    <div className="container mx-auto mt-10 md:mt-[150px] flex flex-col lg:flex-row justify-between items-center gap-[80px]">
      {/* Left Section - Images - No motion on mobile */}
      {isMobile ? (
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-5 w-full">
            <div className="relative rounded-lg overflow-hidden bg-[#0847A4] w-full md:w-auto">
              ...
              <div className="absolute inset-0 flex flex-col justify-around xl:gap-10 p-6">
                ...
                <h1 className="text-[#FFFEFE] font-semibold text-[28px] sm:text-[50px] md:text-[33px] lg:text-[18px] xl:text-[24px]">
      ...
      {/* Right Section - Content - No motion on mobile */}
      {isMobile ? (
        <div className="w-full lg:w-1/2 flex flex-col items-start justify-between">
          <h1 className="text-[#0A1424] font-semibold text-[22px] md:text-[35px] 2xl:text-[48px]">
          ...
          <p className="text-[#494B4E] text-[16px] mt-5 md:mt-2">
            ...
            Antrieben und reduzieren aktiv CO₂-Emissionen. Denn moderne
            Mobilität bedeutet für uns nicht nur Komfort, sondern auch
            Verantwortung.
          </p>
          ...
          <div className="mt-[60px] w-full">
            {steps.map((step, index) => (
              ...
              >
                <img src={step.icon} alt={`Icon ${index + 1}`} />
